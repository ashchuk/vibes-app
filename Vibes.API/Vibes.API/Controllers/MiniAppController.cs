    ...
    public IActionResult Get()
    {
        var html = """
                   ...
                   <head>
                       ...
                       <script async src="https://telegram.org/js/telegram-widget.js?22" data-telegram-login="myvibeappbot" data-size="large" data-userpic="false" data-onauth="onTelegramAuth(user)" data-request-access="write"></script>
                   ...
                   <body class="bg-brand-bg text-brand-secondary antialiased">
                       ...
                       <header class="py-6 px-4 md:px-8 absolute top-0 left-0 w-full z-10">
                           <div class="container mx-auto flex justify-between items-center">
                               ...
                               <a href="#cta" class="bg-brand-primary text-white font-semibold py-2 px-5 rounded-lg hover:bg-opacity-90 transition-colors">
                                   Получить доступ
                               </a>
                           </div>
                       </header>
                       ...
                       <main>
                           ...
                           <section class="relative min-h-screen flex items-center justify-center text-center overflow-hidden pt-24 pb-12 px-4">
                               ...
                               <div class="container mx-auto max-w-3xl relative z-10 reveal">
                                   <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-4 leading-tight">
                                       Ваш ключ к ментальному балансу и продуктивности
                                   </h1>
                                   <p class="text-lg md:text-xl max-w-2xl mx-auto mb-8 text-brand-secondary">
                                       Отслеживайте свое состояние, формируйте полезные привычки и достигайте гармонии с первым умным трекером.
                                   </p>
                                   <a href="#cta" class="bg-brand-primary text-white font-bold py-3 px-8 rounded-lg text-lg hover:scale-105 transition-transform transform">
                           ...
                           <section id="about" class="py-16 md:py-24 px-4 overflow-hidden">
                               <div class="container mx-auto max-w-6xl">
                                   ...
                                   <div class="relative grid grid-cols-1 lg:grid-cols-3 items-center gap-8 md:gap-16">
                                       ...
                                       <!-- Phone Mockup -->
                                       <div class="order-first lg:order-none flex justify-center reveal" style="transition-delay: 100ms;">
                                           <div class="bg-brand-surface p-4 rounded-[40px] border-2 border-gray-800 shadow-2xl shadow-brand-primary/10">
                                               <!-- Placeholder for Phone Mockup Image -->
                                               <img src="https://via.placeholder.com/300x600.png?text=Vibes+App+UI" alt="Интерфейс приложения Vibes" class="rounded-[30px]">
                                           </div>
                                       </div>
                           ...
                           <section id="cta" class="py-16 md:py-32 px-4">
                               <div class="container mx-auto max-w-2xl text-center reveal">
                                   ...
                                   <p class="mt-4 text-lg md:text-xl text-brand-secondary">
                                       Станьте одним из первых пользователей Vibes. Оставьте свои контакты, и мы сообщим вам о запуске и предоставим эксклюзивный доступ.
                                   </p>
                                   <form id="cta-form" class="mt-8 max-w-lg mx-auto" novalidate>
                                       <div class="grid grid-cols-1 gap-4">
                                           <input type="text" id="name" name="name" placeholder="Ваше имя" required class="form-input w-full p-3 rounded-lg bg-brand-surface border border-gray-700 text-white placeholder-gray-500 transition-all">
                                           <input type="email" id="email" name="email" placeholder="Ваш Email" required class="form-input w-full p-3 rounded-lg bg-brand-surface border border-gray-700 text-white placeholder-gray-500 transition-all">
                                           <input type="text" id="messenger" name="messenger" placeholder="Ваш мессенджер (Telegram, VK)" class="form-input w-full p-3 rounded-lg bg-brand-surface border border-gray-700 text-white placeholder-gray-500 transition-all">
                                           <button type="submit" class="w-full bg-brand-accent text-white font-bold py-3 px-6 rounded-lg text-lg hover:bg-green-500 transition-colors transform hover:scale-105">
                                               Получить ранний доступ
                                           </button>
                                       </div>
                                       <p id="form-feedback" class="mt-4 text-sm h-5"></p>
                                   </form>
                               </div>
                           </section>
