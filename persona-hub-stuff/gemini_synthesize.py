...
from prompt_templates import instruction_template, knowledge_template, npc_template, math_template, vibes_template
...
def main(args):
    ...
    elif args.template == "vibes":
        template = vibes_template
    else:
        raise ValueError("Invalid template type. Choose from 'instruction', 'knowledge', 'npc', 'vibes' or 'math'.")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str, 
        required=True, 
        choices=['instruction', 'knowledge', 'npc', 'math', "vibes"],
        help=(
            "Prompt templates. Choose from 'instruction', 'knowledge', 'math', 'npc' or 'vibes'. "
